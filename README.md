# CinemaApp: C# приложение для кинотеатра
...
1. **База данных MS SQL Server:** Приложение использует SQL Server для хранения данных о сеансах, билетах, различной статистики.
